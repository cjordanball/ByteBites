...
number to the highest number. For example: If arr contains [4, 8, 6] then the output
should be 2 because two numbers need to be added to the array (5 and 7) to make it a
consecutive array of numbers from 4 to 8. Negative numbers may be entered as parameters
...
const info = {
	...
	number: 13,
	level: 'medium',
	methods: ['Array.from()', 'sort()'],
	concepts: ['Set objects', 'length property']
};
